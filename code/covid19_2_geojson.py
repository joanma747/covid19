...
def ExtractDatesCsv(csvreader, geoid, geoid_mixed_type, date, fdate, extract_field):
    ...
    if geoid_mixed_type is not None:
        for row in csvreader2:
            if geoid_mixed_type=="int":
                row[geoid]=str(int(row[geoid]))
...
@click.option('-geoid-type', multiple=True, help="Type of comparison for the field in the CSV that connects with a property name geojsonid in the input geojson. (By default comparison is done as strings, use 'int' to force comparisons as integers)")
@click.option('-geoid-mixed-type', multiple=True, help="In the remote case that there is a mix in the geoid field types in the CSV, use this type to find all the observations from the same geoid. (By default finding is done as strings, use 'int' to force comparisons as integers)")
...
def main(href, layer, href_enc, href_type, href_delimiter, mmn, is_acc, add_var, prefix_var, desc_var, color, long, lat, geoid, geoid_type, geoid_mixed_type, geojson, geojsonid, add_longlat, add_field, fdate, date, extract_field, accumulate, cond_field, cond_value, remove_field, population, area, dec_figures, a_circle, export_geojson):
    """
    Import a COVID-19 csv file and edit a config.json to include this data in a vector capa
    ...
    python covid19_2_geojson.py "(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/(p['cfr{time?f=ISO&day=-5}']-p['cfr{time?f=ISO&day=-20}'])>2.5 ? 2.5 : (p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/(p['cfr{time?f=ISO&day=-5}']-p['cfr{time?f=ISO&day=-20}'])" -href-type formula world-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var rt -desc-var "Estimated effective reproduction rate (r<sub>t</sub)>)" -is-not-acc -color 0,54,215 -dec-figures 2 -a-circle 2000
    python covid19_2_geojson.py "(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/(p['cfr{time?f=ISO&day=-5}']-p['cfr{time?f=ISO&day=-20}'])*(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/p['Population']*100000" -href-type formula world-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var epg -desc-var "Estimated Effective Growth Potential (EPG)." -is-not-acc -color 0,128,215 -dec-figures 0 
    python sort_config_json.py world-covid-19 -mmn C:\inetpub\wwwroot\covid19 -section atributs -i-item 0 -i-item 1 -i-item 2 -i-item 3 -i-item 4 -i-item 5 -i-item 32 -i-item 33 -i-item 34 -i-item 31 -i-item 37 -i-item 38 -i-item 7 -i-item 8 -i-item 9 -i-item 6 -i-item 10 -i-item 12 -i-item 13 -i-item 14 -i-item 11 -i-item 15 -i-item 35 -i-item 21 -i-item 22 -i-item 23 -i-item 24 -i-item 17 -i-item 18 -i-item 19 -i-item 16 -i-item 20 -i-item 26 -i-item 27 -i-item 28 -i-item 29 -i-item 30 -i-item 36 
    ...
    python covid19_2_geojson.py "(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/(p['cfr{time?f=ISO&day=-5}']-p['cfr{time?f=ISO&day=-20}'])*(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/p['Population']*100000" -href-type formula prov-spain-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var epg -desc-var "Estimated Effective Growth Potential (EPG)." -is-not-acc -color 0,128,215 -dec-figures 0 
    ...
    python sort_config_json.py prov-spain-covid-19 -mmn C:\inetpub\wwwroot\covid19 -section atributs -i-item 0 -i-item 1 -i-item 2 -i-item 3 -i-item 4 -i-item 5 -i-item 12 -i-item 13 -i-item 14 -i-item 11 -i-item 17 -i-item 18 -i-item 7 -i-item 8 -i-item 9 -i-item 6 -i-item 10 -i-item 15 -i-item 16
    ...
    python covid19_2_geojson.py "(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/(p['cfr{time?f=ISO&day=-5}']-p['cfr{time?f=ISO&day=-20}'])*(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/p['Population']*100000" -href-type formula ccaa-spain-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var epg -desc-var "Estimated Effective Growth Potential (EPG)." -is-not-acc -color 0,128,215 -dec-figures 0
    ...
    python sort_config_json.py ccaa-spain-covid-19 -mmn C:\inetpub\wwwroot\covid19 -section atributs -i-item 0 -i-item 1 -i-item 2 -i-item 3 -i-item 4 -i-item 31 -i-item 32 -i-item 33 -i-item 30 -i-item 36 -i-item 37 -i-item 6 -i-item 7 -i-item 8 -i-item 5 -i-item 9 -i-item 21 -i-item 22 -i-item 23 -i-item 20 -i-item 24 -i-item 50 -i-item 54 -i-item 43 -i-item 44 -i-item 45 -i-item 42 -i-item 47 -i-item 48 -i-item 49 -i-item 46 -i-item 11 -i-item 12 -i-item 13 -i-item 10 -i-item 14 -i-item 16 -i-item 17 -i-item 18 -i-item 15 -i-item 19 -i-item 59 -i-item 60 -i-item 61 -i-item 58 -i-item 63 -i-item 64 -i-item 65 -i-item 62 -i-item 67 -i-item 68 -i-item 69 -i-item 66 -i-item 38 -i-item 39 -i-item 41 -i-item 34 -i-item 26 -i-item 27 -i-item 28 -i-item 25 -i-item 29 -i-item 35
    ...
    python covid19_2_geojson.py "(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/(p['cfr{time?f=ISO&day=-5}']-p['cfr{time?f=ISO&day=-20}'])*(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/p['Population']*100000" -href-type formula rs-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var epg -desc-var "Estimated Effective Growth Potential (EPG)." -is-not-acc -color 0,128,215 -dec-figures 0 
    ...
    python covid19_2_geojson.py "(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/(p['cfr{time?f=ISO&day=-5}']-p['cfr{time?f=ISO&day=-20}'])*(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/p['Population']*100000" -href-type formula ss-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var epg -desc-var "Estimated Effective Growth Potential (EPG)." -is-not-acc -color 0,128,215 -dec-figures 0 
    ...
    python covid19_2_geojson.py "(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/(p['cfr{time?f=ISO&day=-5}']-p['cfr{time?f=ISO&day=-20}'])*(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/p['Population']*100000" -href-type formula abs-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var epg -desc-var "Estimated Effective Growth Potential (EPG)." -is-not-acc -color 0,128,215 -dec-figures 0 
    ...
    python covid19_2_geojson.py "(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/(p['cfr{time?f=ISO&day=-5}']-p['cfr{time?f=ISO&day=-20}'])*(p['cfr{time?f=ISO}']-p['cfr{time?f=ISO&day=-15}'])/p['Population']*100000" -href-type formula coma-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var epg -desc-var "Estimated Effective Growth Potential (EPG)." -is-not-acc -color 0,128,215 -dec-figures 0 
    ...
    python sort_config_json.py rs-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -section atributs -i-item 0 -i-item 1 -i-item 2 -i-item 3 -i-item 4 -i-item 11 -i-item 12 -i-item 13 -i-item 10 -i-item 16 -i-item 17 -i-item 6 -i-item 7 -i-item 8 -i-item 5 -i-item 9 -i-item 14 -i-item 15
    python sort_config_json.py ss-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -section atributs -i-item 0 -i-item 1 -i-item 2 -i-item 3 -i-item 4 -i-item 5 -i-item 6 -i-item 13 -i-item 14 -i-item 15 -i-item 12 -i-item 18 -i-item 19 -i-item 8 -i-item 9 -i-item 10 -i-item 7 -i-item 11 -i-item 16 -i-item 17
    python sort_config_json.py abs-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -section atributs -i-item 0 -i-item 1 -i-item 2 -i-item 3 -i-item 4 -i-item 5 -i-item 6 -i-item 7 -i-item 8 -i-item 15 -i-item 16 -i-item 17 -i-item 14 -i-item 20 -i-item 21 -i-item 10 -i-item 11 -i-item 12 -i-item 9 -i-item 13 -i-item 18 -i-item 19
    python sort_config_json.py coma-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -section atributs -i-item 0 -i-item 1 -i-item 2 -i-item 3 -i-item 4 -i-item 16 -i-item 17 -i-item 18 -i-item 15 -i-item 21 -i-item 22 -i-item 6 -i-item 7 -i-item 8 -i-item 5 -i-item 9 -i-item 11 -i-item 12 -i-item 13 -i-item 10 -i-item 14 -i-item 19 -i-item 20
    fart c:\inetpub\wwwroot\covid19\config.json "\"descripcio\": \"Active estimated per 100000 hab.\"" "\"descripcio\": \"Estimated Cumulative Incidence\"" --c-style

    python covid19_2_geojson.py "https://analisi.transparenciacatalunya.cat/api/views/fk8v-uqfv/rows.csv?accessType=DOWNLOAD&sorting=true" tracacodiv-cat-covid-19 -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "GRUP_CONFIN" -prefix-var grc -desc-var "Nombre of confined groups" -geoid CODCENTRE -geoid-mixed-type int -geoid-type int -add-longlat -add-field "Denominació completa" -add-field "Nom naturalesa" -add-field "Nom titularitat" -add-field "Adreça" -add-field "Codi postal" -add-field "Nom comarca" -add-field "Nom municipi" -add-field "Codi districte municipal" -add-field "Nom DM": -add-field "Estudis" -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 100
    python covid19_2_geojson.py "https://analisi.transparenciacatalunya.cat/api/views/fk8v-uqfv/rows.csv?accessType=DOWNLOAD&sorting=true" tracacodiv-cat-covid-19 -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "ALUMN_CONFIN" -add-var -prefix-var stc -desc-var "Nombre of confined studens" -geoid CODCENTRE -geoid-mixed-type int -geoid-type int -add-longlat -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "https://analisi.transparenciacatalunya.cat/api/views/fk8v-uqfv/rows.csv?accessType=DOWNLOAD&sorting=true" tracacodiv-cat-covid-19 -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "DOCENT_CONFIN" -add-var -prefix-var tec -desc-var "Nombre de confined teachers, PAS and PAE" -geoid CODCENTRE -geoid-mixed-type int -geoid-type int -add-longlat -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "https://analisi.transparenciacatalunya.cat/api/views/fk8v-uqfv/rows.csv?accessType=DOWNLOAD&sorting=true" tracacodiv-cat-covid-19 -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "ALTRES_CONFIN" -add-var -prefix-var exc -desc-var "Nombre de confined external staff" -geoid CODCENTRE -geoid-mixed-type int -geoid-type int -add-longlat -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "(p['stc{time?f=ISO}']+p['tec{time?f=ISO}']+p['exc{time?f=ISO}']==0) ? '' : p['stc{time?f=ISO}']+p['tec{time?f=ISO}']+p['exc{time?f=ISO}']" -href-type formula tracacodiv-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var pec -desc-var "Nombre de confined people" -is-not-acc -a-circle 25
    fart c:\inetpub\wwwroot\covid19\config.json "\"descripcio\": \"CODCENTRE\"" "\"descripcio\": \"Codi de centre\"" --c-style
    ...
    python covid19_2_geojson.py "https://analisi.transparenciacatalunya.cat/api/views/fk8v-uqfv/rows.csv?accessType=DOWNLOAD&sorting=true" tracacodiv-cat-covid-19 -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "GRUP_CONFIN" -prefix-var grc -desc-var "Nombre of confined groups" -geoid CODCENTRE -geoid-type int -add-longlat -add-field "Denominació completa" -add-field "Nom naturalesa" -add-field "Nom titularitat" -add-field "Adreça" -add-field "Codi postal" -add-field "Nom comarca" -add-field "Nom municipi" -add-field "Codi districte municipal" -add-field "Nom DM": -add-field "Estudis" -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "https://analisi.transparenciacatalunya.cat/api/views/fk8v-uqfv/rows.csv?accessType=DOWNLOAD&sorting=true" tracacodiv-cat-covid-19 -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "ALUMN_CONFIN" -add-var -prefix-var stc -desc-var "Nombre of confined studens" -geoid CODCENTRE -geoid-type int -add-longlat -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "https://analisi.transparenciacatalunya.cat/api/views/fk8v-uqfv/rows.csv?accessType=DOWNLOAD&sorting=true" tracacodiv-cat-covid-19 -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "DOCENT_CONFIN" -add-var -prefix-var tec -desc-var "Nombre de confined teachers, PAS and PAE" -geoid CODCENTRE -geoid-type int -add-longlat -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "https://analisi.transparenciacatalunya.cat/api/views/fk8v-uqfv/rows.csv?accessType=DOWNLOAD&sorting=true" tracacodiv-cat-covid-19 -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "ALTRES_CONFIN" -add-var -prefix-var exc -desc-var "Nombre de confined external staff" -geoid CODCENTRE -geoid-type int -add-longlat -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "(p['stc{time?f=ISO}']+p['tec{time?f=ISO}']+p['exc{time?f=ISO}']==0) ? '' : p['stc{time?f=ISO}']+p['tec{time?f=ISO}']+p['exc{time?f=ISO}']" -href-type formula tracacodiv-cat-covid-19 -mmn C:\inetpub\wwwroot\covid19 -add-var -prefix-var pec -desc-var "Nombre de confined people" -is-not-acc -a-circle 25

    python covid19_2_geojson.py "d:\Dades_COVID-19.csv" tracacodiv-cat-covid-19 -href-type local -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "GRUP_CONFIN" -prefix-var grc -desc-var "Nombre of confined groups" -geoid CODCENTRE -geoid-type int -add-longlat -add-field "Denominació completa" -add-field "Nom naturalesa" -add-field "Nom titularitat" -add-field "Adreça" -add-field "Codi postal" -add-field "Nom comarca" -add-field "Nom municipi" -add-field "Codi districte municipal" -add-field "Nom DM": -add-field "Estudis" -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "d:\Dades_COVID-19.csv" tracacodiv-cat-covid-19 -href-type local -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "ALUMN_CONFIN" -add-var -prefix-var stc -desc-var "Nombre of confined studens" -geoid CODCENTRE -geoid-type int -add-longlat -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "d:\Dades_COVID-19.csv" tracacodiv-cat-covid-19 -href-type local -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "DOCENT_CONFIN" -add-var -prefix-var tec -desc-var "Nombre de confined teachers, PAS and PAE" -geoid CODCENTRE -geoid-type int -add-longlat -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    python covid19_2_geojson.py "d:\Dades_COVID-19.csv" tracacodiv-cat-covid-19 -href-type local -href-enc utf8 -mmn C:\inetpub\wwwroot\covid19 -geojson "D:\datacube\covid-19\centresDocents.geojson" -extract-field "ALTRES_CONFIN" -add-var -prefix-var exc -desc-var "Nombre de confined external staff" -geoid CODCENTRE -geoid-type int -add-longlat -is-not-acc -fdate dd/mm/yyyy -date DATAGENERACIO -a-circle 25
    ...
    try: 
        ...
        if href_type=="formula":
            ...
            if (date is None):
                ...
                csvreader = ExtractDatesCsv(csvreader, geoid[0], None if len(geoid_mixed_type)==0 else geoid_mixed_type[0], date, fdate, extract_field)
